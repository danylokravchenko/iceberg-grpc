...
// GetStorageCredentials returns the StorageCredentials field value if set, zero value otherwise.
func (o *LoadTableResult) GetStorageCredentials() []StorageCredential {
	if o == nil || IsNil(o.StorageCredentials) {
...
// GetStorageCredentialsOk returns a tuple with the StorageCredentials field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetStorageCredentials gets a reference to the given []StorageCredential and assigns it to the StorageCredentials field.
