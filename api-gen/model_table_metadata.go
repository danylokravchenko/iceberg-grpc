...
type TableMetadata struct {
	...
	SnapshotLog []SnapshotLogInner `json:"snapshot-log,omitempty"`
	MetadataLog []MetadataLogInner `json:"metadata-log,omitempty"`
...
func (o *TableMetadata) GetRefs() map[string]SnapshotReference {
	if o == nil || IsNil(o.Refs) {
		var ret map[string]SnapshotReference
		return ret
	}
	return o.Refs
}
...
func (o *TableMetadata) GetRefsOk() (map[string]SnapshotReference, bool) {
	if o == nil || IsNil(o.Refs) {
		return map[string]SnapshotReference{}, false
	}
	return o.Refs, true
}
...
// SetRefs gets a reference to the given map[string]SnapshotReference and assigns it to the Refs field.
...
// SetSnapshotLog gets a reference to the given []SnapshotLogInner and assigns it to the SnapshotLog field.
...
// SetMetadataLog gets a reference to the given []MetadataLogInner and assigns it to the MetadataLog field.
...
// SetStatistics gets a reference to the given []StatisticsFile and assigns it to the Statistics field.
func (o *TableMetadata) SetStatistics(v []StatisticsFile) {
	o.Statistics = v
}

// GetPartitionStatistics returns the PartitionStatistics field value if set, zero value otherwise.
func (o *TableMetadata) GetPartitionStatistics() []PartitionStatisticsFile {
	if o == nil || IsNil(o.PartitionStatistics) {
...
// GetPartitionStatisticsOk returns a tuple with the PartitionStatistics field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPartitionStatistics gets a reference to the given []PartitionStatisticsFile and assigns it to the PartitionStatistics field.
...
func (o TableMetadata) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PartitionStatistics) {
