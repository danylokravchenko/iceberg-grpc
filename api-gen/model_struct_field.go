...
// GetInitialDefault returns the InitialDefault field value if set, zero value otherwise.
func (o *StructField) GetInitialDefault() PrimitiveTypeValue {
	if o == nil || IsNil(o.InitialDefault) {
		var ret PrimitiveTypeValue
		return ret
	}
	return *o.InitialDefault
}

// GetInitialDefaultOk returns a tuple with the InitialDefault field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StructField) GetInitialDefaultOk() (*PrimitiveTypeValue, bool) {
	if o == nil || IsNil(o.InitialDefault) {
		return nil, false
	}
	return o.InitialDefault, true
}
...
// SetInitialDefault gets a reference to the given PrimitiveTypeValue and assigns it to the InitialDefault field.
func (o *StructField) SetInitialDefault(v PrimitiveTypeValue) {
	o.InitialDefault = &v
}

// GetWriteDefault returns the WriteDefault field value if set, zero value otherwise.
func (o *StructField) GetWriteDefault() PrimitiveTypeValue {
	if o == nil || IsNil(o.WriteDefault) {
		var ret PrimitiveTypeValue
		return ret
	}
	return *o.WriteDefault
}

// GetWriteDefaultOk returns a tuple with the WriteDefault field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StructField) GetWriteDefaultOk() (*PrimitiveTypeValue, bool) {
	if o == nil || IsNil(o.WriteDefault) {
		return nil, false
	}
	return o.WriteDefault, true
}
...
// SetWriteDefault gets a reference to the given PrimitiveTypeValue and assigns it to the WriteDefault field.
...
func (o StructField) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InitialDefault) {
		toSerialize["initial-default"] = o.InitialDefault
	}
	if !IsNil(o.WriteDefault) {
		toSerialize["write-default"] = o.WriteDefault
	}
