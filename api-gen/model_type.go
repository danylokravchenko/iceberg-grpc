...
func (dst *Type) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.ListType)
	if err == nil {
		jsonListType, _ := json.Marshal(dst.ListType)
		if string(jsonListType) == "{}" { // empty struct
			dst.ListType = nil
		} else {
			if err = validator.Validate(dst.ListType); err != nil {
				dst.ListType = nil
			} else {
				match++
			}
	...
	err = newStrictDecoder(data).Decode(&dst.MapType)
	if err == nil {
		jsonMapType, _ := json.Marshal(dst.MapType)
		if string(jsonMapType) == "{}" { // empty struct
			dst.MapType = nil
		} else {
			if err = validator.Validate(dst.MapType); err != nil {
				dst.MapType = nil
			} else {
				match++
			}
	...
	err = newStrictDecoder(data).Decode(&dst.StructType)
	if err == nil {
		jsonStructType, _ := json.Marshal(dst.StructType)
		if string(jsonStructType) == "{}" { // empty struct
			dst.StructType = nil
		} else {
			if err = validator.Validate(dst.StructType); err != nil {
				dst.StructType = nil
			} else {
				match++
			}
...
func (obj Type) GetActualInstanceValue() (interface{}) {
	if obj.ListType != nil {
		return *obj.ListType
	}
