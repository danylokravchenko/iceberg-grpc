...
// List of TokenType
const (
	URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_ACCESS_TOKEN TokenType = "urn:ietf:params:oauth:token-type:access_token"
	URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_REFRESH_TOKEN TokenType = "urn:ietf:params:oauth:token-type:refresh_token"
	URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_ID_TOKEN TokenType = "urn:ietf:params:oauth:token-type:id_token"
	URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_SAML1 TokenType = "urn:ietf:params:oauth:token-type:saml1"
	URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_SAML2 TokenType = "urn:ietf:params:oauth:token-type:saml2"
	URN_IETF_PARAMS_OAUTH_TOKEN_TYPE_JWT TokenType = "urn:ietf:params:oauth:token-type:jwt"
)
